...
!function (e, t) {
  ...
  return function (e) {
    ...
    var o, r, i;
    r = [t, n(0), n(11)], void 0 === (i = "function" == typeof (o = function (n, o, r) {
      "use strict";
    ...
    var o, r, i;
    r = [t], void 0 === (i = "function" == typeof (o = function (n) {
      "use strict";
    ...
    var o, r, i;
    r = [t, n(0), n(1), n(2), n(19), n(20), n(21)], void 0 === (i = "function" == typeof (o = function (n, o, r, i, a, l, c) {
      "use strict";
      ...
      }(o), r = s(r), i = s(i), a = s(a), l = s(l), c = s(c);
      ...
      var b = 1e3,
        ...
        return function (e, t) {
          ...
          key: "onAddTopBar",
          value: function (e) {
            for (var t = this, n = ["All", "Log", "Info", "Warn", "Error"], o = [], i = 0; i < n.length; i++) o.push({
              name: n[i],
              data: {
          ...
          value: function () {
            ...
            r.default.bind(t, "click", function (n) {
              if (n.preventDefault(), r.default.hasClass(this, "vc-actived")) return !1;
              ...
              r.default.removeClass(i, "vc-log-partly-log"), r.default.removeClass(i, "vc-log-partly-info"), r.default.removeClass(i, "vc-log-partly-warn"), r.default.removeClass(i, "vc-log-partly-error"), "all" == o ? r.default.removeClass(i, "vc-log-partly") : (r.default.addClass(i, "vc-log-partly"), r.default.addClass(i, "vc-log-partly-" + o));
            });
          ...
          value: function (e) {
            ...
            if (t.length || e.content) {
              ...
              if (o.isString(t[0])) {
                var a = t[0].match(n);
                null !== a && a.length > 0 && (r = a[1].toLowerCase(), i = m.indexOf(r) > -1);
              }
              ...
              if (r === this.id || !0 !== i && "default" === this.id) {
                if (e._id || (e._id = "__vc_" + Math.random().toString(36).substring(2, 8)), e.date || (e.date = +new Date()), this.isReady) {
                  o.isString(t[0]) && i && (t[0] = t[0].replace(n, ""), "" === t[0] && t.shift());
                  ...
                  for (var l = {
                    ...
                    count: 1
                  }, c = 0; c < t.length; c++) o.isFunction(t[c]) ? l.logText.push(t[c].toString()) : o.isObject(t[c]) || o.isArray(t[c]) ? l.logText.push(o.JSONStringify(t[c])) : l.logText.push(t[c]);
          ...
          value: function (e, t) {
            ...
            if (o.isString(t[0]) && i.test(t[0])) {
              ...
              }), s = t[0].match(i), d = 0; d < s.length; d++) o.isString(t[d + 1]) && l.push(t[d + 1]);

              for (var f = s.length + 1; f < t.length; f++) c.push(t[f]);
            ...
            for (var v = r.default.one(".vc-item-content", n), p = 0; p < t.length; p++) {
              ...
              try {
                if ("" === t[p]) continue;
                h = o.isFunction(t[p]) ? "<span> " + t[p].toString() + "</span>" : o.isObject(t[p]) || o.isArray(t[p]) ? this.getFoldedLine(t[p]) : (l[p] ? '<span style="'.concat(l[p], '"> ') : "<span> ") + o.htmlEncode(t[p]).replace(/\n/g, "<br/>") + "</span>";
              } catch (e) {
                h = "<span> [" + u(t[p]) + "]</span>";
              }
            ...
            o.isObject(e.content) && v.insertAdjacentElement("beforeend", e.content), this.formatLine && (n = this.formatLine(n)), r.default.one(".vc-log", this.$tabbox).insertAdjacentElement("beforeend", n), this.logNumber++, this.limitMaxLogs();
          }
        }, {
          key: "getFoldedLine",
          value: function (e, t) {
              ...
              return setTimeout(function () {
                if (0 == i.children.length && e) {
                  for (var t = o.getObjAllKeys(e), a = 0; a < t.length; a++) {
                    ...
                    o.isString(s) ? (d = "string", s = '"' + s + '"') : o.isNumber(s) ? d = "number" : o.isBoolean(s) ? d = "boolean" : o.isNull(s) ? (d = "null", s = "null") : o.isUndefined(s) ? (d = "undefined", s = "undefined") : o.isFunction(s) ? (d = "function", s = "function()") : o.isSymbol(s) && (d = "symbol");
                    var f = void 0;

                    if (o.isArray(s)) {
                      var v = o.getObjName(s) + "[" + s.length + "]";
                      f = n.getFoldedLine(s, r.default.render(c.default, {
                        key: t[a],
                        keyType: u,
                        value: v,
                        valueType: "array"
                      ...
                      f = r.default.render(l.default, h);
                    }
                  ...
                  if (o.isObject(e)) {
                    var b,
                        m = e.__proto__;
                    b = o.isObject(m) ? n.getFoldedLine(m, r.default.render(c.default, {
                      key: "__proto__",
                      keyType: "private",
    ...
    e.exports = function (e) {
      ...
      return t.toString = function () {
        ...
        for (var a = 0; a < e.length; a++) {
          var l = e[a];
          null != l[0] && o[l[0]] || (n && !l[2] ? l[2] = n : n && (l[2] = "(".concat(l[2], ") and (").concat(n, ")")), t.push(l));
        }
      }, t;
    };
  }, function (e, t, n) {
    ...
    function c(e, t) {
      for (var n = 0; n < e.length; n++) {
        ...
        if (i) {
          ...
          for (var l = []; a < o.parts.length; a++) l.push(b(o.parts[a], t));
    ...
    function b(e, t) {
      ...
      if (t.singleton) {
        var i = h++;
        n = p || (p = s(t)), o = f.bind(null, n, i, !1), r = f.bind(null, n, i, !0);
      } else n = s(t), o = v.bind(null, n, t), r = function () {
        !function (e) {
    ...
    var o, r, i;
    r = [t, n(7), n(8)], void 0 === (i = "function" == typeof (o = function (n, o, r) {
      "use strict";
    ...
    var o, r, i;
    r = [t, n(9), n(10), n(0), n(1), n(12), n(14), n(15), n(16), n(17), n(18), n(2), n(3), n(22), n(25), n(27), n(31), n(39)], void 0 === (i = "function" == typeof (o = function (n, o, r, i, a, l, c, s, d, u, f, v, p, h, b, m, g, y) {
      "use strict";
      ...
      Object.defineProperty(n, "__esModule", {
        value: !0
      }), n.default = void 0, r = w(r), i = function (e) {
        if (e && e.__esModule) return e;
        ...
        return n.default = e, t && t.set(e, n), n;
      }(i), a = w(a), c = w(c), s = w(s), d = w(d), u = w(u), f = w(f), v = w(v), p = w(p), h = w(h), b = w(b), m = w(m), g = w(g), y = w(y);
      ...
      var x = "#__vconsole",
        ...
        function e(t) {
          if (function (e, t) {
            ...
            var n = this;
            if (this.version = r.default.version, this.$dom = null, this.isInited = !1, this.option = {
              ...
              endX: 0,
              endY: 0
            }, this.tool = i, this.$ = a.default, i.isObject(t)) for (var o in t) this.option[o] = t[o];
        ...
        return t = e, (n = [{
          ...
          value: function () {
            ...
            if (e && i.isArray(e)) for (var n = 0; n < e.length; n++) {
              var o = t[e[n]];
          ...
          value: function () {
            if (!a.default.one(x)) {
              ...
              e.innerHTML = c.default, document.documentElement.insertAdjacentElement("beforeend", e.children[0]);
            }

            this.$dom = a.default.one(x);
            ...
            if (l && l.content) {
              ...
              (s ? parseFloat(s[0].split("=")[1]) : 1) < 1 && (this.$dom.style.fontSize = 13 * r + "px");
            }
          ...
          value: function () {
            ...
            this.$dom.addEventListener("touchstart", function (o) {
              if (void 0 === e) {
                ...
                t = i.pageX, n = i.pageY, e = o.timeStamp, r = o.target.nodeType === Node.TEXT_NODE ? o.target.parentNode : o.target;
              }
              ...
              if (!1 === o && t.timeStamp - e < 700 && null != r) {
                ...
                n ? r.focus() : "function" == typeof window.getSelection && getSelection().rangeCount || t.preventDefault();
          ...
          value: function () {
            ...
            var s = a.default.one(".vc-content", e.$dom),
                d = !1;
            a.default.bind(s, "touchstart", function (e) {
              var t = s.scrollTop,
                  n = s.scrollHeight,
                  o = t + s.offsetHeight;
              0 === t ? (s.scrollTop = 1, 0 === s.scrollTop && (a.default.hasClass(e.target, "vc-cmd-input") || (d = !0))) : o === n && (s.scrollTop = t - 1, s.scrollTop === t && (a.default.hasClass(e.target, "vc-cmd-input") || (d = !0)));
          ...
          value: function (e) {
            ...
            e.vConsole = this, e.trigger("init"), e.trigger("renderTab", function (n) {
              t.tabList.push(e.id);
              var o = a.default.render(s.default, {
                id: e.id,
                name: e.name
              });
              a.default.one(".vc-tabbar", t.$dom).insertAdjacentElement("beforeend", o);
              var r = a.default.render(d.default, {
                id: e.id
              });
              n && (i.isString(n) ? r.innerHTML += n : i.isFunction(n.appendTo) ? n.appendTo(r) : i.isElement(n) && r.insertAdjacentElement("beforeend", n)), a.default.one(".vc-content", t.$dom).insertAdjacentElement("beforeend", r);
            }), e.trigger("addTopBar", function (n) {
              if (n) for (var o = a.default.one(".vc-topbar", t.$dom), r = function (t) {
                var r = n[t],
                    l = a.default.render(u.default, {
                  name: r.name || "Undefined",
                  className: r.className || "",
                  pluginID: e.id
                });
                if (r.data) for (var c in r.data) l.dataset[c] = r.data[c];
              ...
              if (n) for (var o = a.default.one(".vc-tool-last", t.$dom), r = function (t) {
                var r = n[t],
                    l = a.default.render(f.default, {
                  name: r.name || "Undefined",
                  pluginID: e.id
                });
                1 == r.global && a.default.addClass(l, "vc-global-tool"), i.isFunction(r.onClick) && a.default.bind(l, "click", function (e) {
                  r.onClick.call(l);
          ...
          value: function (e) {
            ...
            if (t.trigger("remove"), this.isInited) {
              ...
              for (var o = a.default.all(".vc-topbar-" + e, this.$dom), r = 0; r < o.length; r++) o[r].parentNode.removeChild(o[r]);

              var i = a.default.one("#__vc_log_" + e);
              i && i.parentNode.removeChild(i);

              for (var l = a.default.all(".vc-tool-" + e, this.$dom), c = 0; c < l.length; c++) l[c].parentNode.removeChild(l[c]);
            }
      ...
      k.VConsolePlugin = v.default, k.VConsoleLogPlugin = p.default, k.VConsoleDefaultPlugin = h.default, k.VConsoleSystemPlugin = b.default, k.VConsoleNetworkPlugin = m.default, k.VConsoleElementPlugin = g.default, k.VConsoleStoragePlugin = y.default;
      var O = k;
    ...
    !function (e) {
      ...
      var o = {
        ...
        getPosition: function (e) {
          ...
          for (var t = 0, n = this.list.length; t < n; t++) if (this.list[t] === e) return t;
    ...
    r = [t], void 0 === (i = "function" == typeof (o = function (n) {
      ...
      Object.defineProperty(n, "__esModule", {
        ...
        for (window.__mito_data = t, window.__mito_code = "", window.__mito_result = "", e = (e = e.replace(/(\{\{ ?switch(.+?)\}\})[\r\n\t ]+\{\{/g, "$1{{")).replace(/^[\r\n]/, "").replace(/\n/g, "\\\n").replace(/\r/g, "\\\r"), i = "(function(){\n", r = "var arr = [];\n"; l = o.exec(e);) c(e.slice(a, l.index), !1), c(l[1], !0), a = l.index + l[0].length;
      ...
      var filterText = "",
        ...
        return _inherits(VConsoleDefaultTab, _VConsoleLogTab), _createClass(VConsoleDefaultTab, [{
          ...
          value: function () {
            ...
            var e = this;
            tool.isFunction(window.onerror) && (this.windowOnError = window.onerror), window.onerror = function (t, n, o, r, i) {
              var a = t;
              n && (a += "\n" + n.replace(location.origin, "")), (o || r) && (a += ":" + o + ":" + r);
              var l = !!i && !!i.stack && i.stack.toString() || "";
              e.printLog({
                logType: "error",
                logs: [a, l],
                noOrigin: !0
              }), tool.isFunction(e.windowOnError) && e.windowOnError.call(window, t, n, o, r, i);
            };
          }
        }, {
          key: "evalCommand",
    ...
    var o, r, i;
    r = [t, n(3), n(26)], void 0 === (i = "function" == typeof (o = function (n, o, r) {
      "use strict";
      ...
      var f = function (e) {
        ...
        return function (e, t) {
          ...
          value: function () {
            ...
            t = "Unknown", i ? t = "Android " + i[2] : r ? t = "iPhone, iOS " + r[2].replace(/_/g, ".") : o ? t = "iPad, iOS " + o[2].replace(/_/g, ".") : n && (t = "iPod, iOS " + n[2].replace(/_/g, "."));
            var a = t,
    ...
    var o, r, i;
    r = [t, n(1), n(0), n(2), n(28), n(29), n(30)], void 0 === (i = "function" == typeof (o = function (n, o, r, i, a, l, c) {
      "use strict";
      ...
      Object.defineProperty(n, "__esModule", {
        value: !0
      }), n.default = void 0, o = d(o), r = function (e) {
        if (e && e.__esModule) return e;
        var t = s();
        if (t && t.has(e)) return t.get(e);
        var n = {};
      ...
      var b = function (e) {
        function t() {
          ...
          return (n = v(this, (e = p(t)).call.apply(e, [this].concat(i)))).$tabbox = o.default.render(a.default, {}), n.$header = null, n.reqList = {}, n.domList = {}, n.isReady = !1, n.isShow = !1, n.isInBottom = !0, n._open = void 0, n._send = void 0, n.mockAjax(), n.mockFetch(), n;
        }
        ...
        return function (e, t) {
          ...
          value: function () {
            ...
            e.isReady = !0, this.renderHeader(), o.default.delegate(o.default.one(".vc-log", this.$tabbox), "click", ".vc-group-preview", function (t) {
              var n = this.dataset.reqid,
                  r = this.parentNode;
              o.default.hasClass(r, "vc-actived") ? (o.default.removeClass(r, "vc-actived"), e.updateRequest(n, {
                actived: !1
              })) : (o.default.addClass(r, "vc-actived"), e.updateRequest(n, {
                actived: !0
              })), t.preventDefault();
            });
          ...
          value: function (e, t) {
            ...
            if (this.reqList[e] = i, this.isReady) {
              ...
              var s = o.default.render(c.default, l),
                  d = this.domList[e];
              i.status >= 400 && o.default.addClass(o.default.one(".vc-group-preview", s), "vc-table-row-error"), d ? d.parentNode.replaceChild(s, d) : o.default.one(".vc-log", this.$tabbox).insertAdjacentElement("beforeend", s), this.domList[e] = s, Object.keys(this.reqList).length != n && this.renderHeader(), this.isInBottom && this.scrollToBottom();
            }
          }
        }, {
          key: "mockAjax",
            ...
            if (window.XMLHttpRequest) {
              ...
              e._open = t, e._send = n, window.XMLHttpRequest.prototype.open = function () {
                ...
                var c = n.onreadystatechange || function () {},
                    s = function () {
                  var t = e.reqList[a] || {};
                  if (t.readyState = n.readyState, t.status = 0, n.readyState > 1 && (t.status = n.status), t.responseType = n.responseType, 0 == n.readyState) t.startTime || (t.startTime = +new Date());else if (1 == n.readyState) t.startTime || (t.startTime = +new Date());else if (2 == n.readyState) {
                    t.header = {};

                    for (var o = n.getAllResponseHeaders() || "", r = o.split("\n"), i = 0; i < r.length; i++) {
                      var s = r[i];
                  ...
                  } else 3 == n.readyState || (4 == n.readyState ? (clearInterval(l), t.endTime = +new Date(), t.costTime = t.endTime - (t.startTime || t.endTime), t.response = n.response) : clearInterval(l));
                  return n._noVConsole || e.updateRequest(a, t), c.apply(n, arguments);
                };
                ...
                if (a.url = l.shift(), l.length > 0) {
                  ...
                  try {
                    for (var u, f = l[Symbol.iterator](); !(c = (u = f.next()).done); c = !0) {
                      var v = u.value;
                      v = v.split("="), a.getData[v[0]] = decodeURIComponent(v[1]);
                    }
                  } catch (e) {
                    s = !0, d = e;
                  } finally {
          ...
          value: function () {
            ...
            if (e) {
              ...
              window.fetch = function (n, o) {
                ...
                if (a.id = i, a.method = o.method || "GET", a.url = l.shift(), l.length > 0) {
                  a.getData = {}, l = (l = l.join("?")).split("&");
                  var c = !0,
                      s = !1,
                      d = void 0;
                ...
                } else r.isPlainObject(data) && (a.postData = data);
                return a.startTime || (a.startTime = +new Date()), e(n, o).then(function (e) {
                  return e.clone().json().then(function (t) {
                    a.endTime = +new Date(), a.costTime = a.endTime - (a.startTime || a.endTime), a.status = e.status, a.header = {};
                    var n = !0,
                        o = !1,
                        r = void 0;
                    ...
                    return a.responseType = s.includes("application/json") ? "json" : s.includes("text/html") ? "text" : "", t;
      ...
      n.default = b, e.exports = t.default;
    }) ? o.apply(t, r) : o) || (e.exports = i);
  }, function (e, t) {
    ...
    var o, r, i;
    r = [t, n(32), n(33), n(2), n(35), n(36), n(0), n(1)], void 0 === (i = "function" == typeof (o = function (n, o, r, i, a, l, c, s) {
      "use strict";
      ...
      Object.defineProperty(n, "__esModule", {
        value: !0
      }), n.default = void 0, o = u(o), i = u(i), a = u(a), l = u(l), c = function (e) {
        if (e && e.__esModule) return e;
        var t = d();
        if (t && t.has(e)) return t.get(e);
        var n = {};
      ...
      var m = function (e) {
        function t() {
          ...
          r = this, n = !(i = (e = p(t)).call.apply(e, [this].concat(c))) || "object" !== f(i) && "function" != typeof i ? h(r) : i;
          var u = h(n);
          return u.isInited = !1, u.node = {}, u.$tabbox = s.default.render(a.default, {}), u.nodes = [], u.activedElem = {}, u.observer = new o.default(function (e) {
        ...
        return function (e, t) {
            ...
            e([{
              ...
              onClick: function (e) {
                if (t.activedElem) if (s.default.hasClass(t.activedElem, "vc-toggle")) for (var n = 0; n < t.activedElem.childNodes.length; n++) {
                  ...
                  if (s.default.hasClass(o, "vcelm-l") && !s.default.hasClass(o, "vcelm-noc") && !s.default.hasClass(o, "vc-toggle")) {
                    s.default.one(".vcelm-node", o).click();
                    break;
                  }
          ...
          value: function () {
            if (!this.isInited) {
              ...
              var e = this.renderView(this.node, s.default.one(".vc-log", this.$tabbox)),
                  t = s.default.one(".vcelm-node", e);
          ...
          value: function (e) {
            ...
            if (n) {
              this.getNode(t), n.view && s.default.removeClass(n.view, "vcelm-noc");
          ...
          value: function (e, t, n) {
            var o = this,
                r = new l.default(e).get();

            switch (e.view = r, s.default.delegate(r, "click", ".vcelm-node", function (t) {
              t.stopPropagation();
              var n = this.parentNode;

              if (!s.default.hasClass(n, "vcelm-noc")) {
                o.activedElem = n, s.default.hasClass(n, "vc-toggle") ? s.default.removeClass(n, "vc-toggle") : s.default.addClass(n, "vc-toggle");

                for (var r = -1, i = 0; i < n.children.length; i++) {
                  var a = n.children[i];
                  s.default.hasClass(a, "vcelm-l") && (r++, a.children.length > 0 || (e.childNodes[r] ? o.renderView(e.childNodes[r], a, "replace") : a.style.display = "none"));
                }
              }
            }), n) {
              case "replace":
    ...
    function _(e) {
      return h || ((n = new g((t = p).type, t.target)).addedNodes = t.addedNodes.slice(), n.removedNodes = t.removedNodes.slice(), n.previousSibling = t.previousSibling, n.nextSibling = t.nextSibling, n.attributeName = t.attributeName, n.attributeNamespace = t.attributeNamespace, n.oldValue = t.oldValue, (h = n).oldValue = e, h);
      var t, n;
    }

    function w(e, t) {
      return e === t ? e : h && ((n = e) === h || n === p) ? h : null;
      var n;
    }
    ...
    m.prototype = {
      ...
      enqueue: function (e) {
        ...
        } else t = this.observer, u.push(t), d || (d = !0, l(f));
      ...
      removeTransientObservers: function () {
        ...
        this.transientObservedNodes = [], e.forEach(function (e) {
          ...
          for (var t = a.get(e), n = 0; n < t.length; n++) if (t[n] === this) {
            t.splice(n, 1);
            break;
          }
        }, this);
        ...
        switch (e.stopImmediatePropagation(), e.type) {
          case "DOMAttrModified":
            var t = e.attrName,
                ...
                o = e.target;
            (i = new y("attributes", o)).attributeName = t, i.attributeNamespace = n;
            var r = null;
            "undefined" != typeof MutationEvent && e.attrChange === MutationEvent.ADDITION || (r = e.prevValue), v(o, function (e) {
          ...
          case "DOMNodeInserted":
            ...
            var a,
                l,
                c = e.target;
            "DOMNodeInserted" === e.type ? (a = [c], l = []) : (a = [], l = [c]);
            var s = c.previousSibling,
                d = c.nextSibling;
            (i = y("childList", o)).addedNodes = a, i.removedNodes = l, i.previousSibling = s, i.nextSibling = d, v(o, function (e) {
    ...
    var o, r, i;
    r = [t, n(37), n(38), n(0), n(1)], void 0 === (i = "function" == typeof (o = function (n, o, r, i, a) {
      "use strict";
      ...
      Object.defineProperty(n, "__esModule", {
        value: !0
      }), n.default = void 0, o = c(o), r = c(r), i = function (e) {
        if (e && e.__esModule) return e;
        var t = l();
        if (t && t.has(e)) return t.get(e);
        var n = {};
      ...
      var d = function () {
        ...
        return t = e, (n = [{
          ...
          value: function (e, t) {
            ...
            var c = a.default.render(o.default, {
              node: e
            }),
    ...
    var o, r, i;
    r = [t, n(2), n(40), n(41), n(0), n(1)], void 0 === (i = "function" == typeof (o = function (n, o, r, i, a, l) {
      "use strict";
      ...
      Object.defineProperty(n, "__esModule", {
        value: !0
      }), n.default = void 0, o = s(o), r = s(r), i = s(i), a = function (e) {
        if (e && e.__esModule) return e;
        var t = c();
        if (t && t.has(e)) return t.get(e);
        var n = {};
      ...
      var h = function (e) {
        function t() {
          ...
          return (n = f(this, (e = v(t)).call.apply(e, [this].concat(i)))).$tabbox = l.default.render(r.default, {}), n.currentType = "", n.typeNameMap = {
            cookies: "Cookies",
        ...
        return function (e, t) {
          ...
          key: "onAddTopBar",
          value: function (e) {
            for (var t = this, n = ["Cookies", "LocalStorage", "SessionStorage"], o = [], r = 0; r < n.length; r++) o.push({
              name: n[r],
              data: {
